// lib/features/voice_text/screens/lingua_master_screen.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:flutter/services.dart';
import 'package:google_mlkit_translation/google_mlkit_translation.dart';
// 🔥 İMPORT YOLU DÜZELTİLDİ
...
// 🔥 İSİM DÜZELTİLDİ: LinguaMasterScreen
class LinguaMasterScreen extends StatefulWidget {
  const LinguaMasterScreen({super.key});

  @override
  State<LinguaMasterScreen> createState() => _LinguaMasterScreenState();
}

class _LinguaMasterScreenState extends State<LinguaMasterScreen> {
  final TextEditingController _controller = TextEditingController();

  @override
  Widget build(BuildContext context) {
    // 🔥 PROVIDER ÇAĞRISI DÜZELTİLDİ
    final provider = Provider.of<LinguaMasterProvider>(context);
